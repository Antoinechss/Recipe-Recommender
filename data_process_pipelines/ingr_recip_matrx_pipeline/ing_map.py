...
"vegetables": {
    ...
    "broccoli": ["brocoli"],
    "squash_pumpkin": ["courge", "courge pâtes", "potiron", "citrouille"],
    "celery": ["céleri"],
...
"fruits_nuts": {
    ...
    "berries": ["fraises", "framboises", "myrtilles", "fruits rouges", "coulis fruits rouges"],
    "cherry": ["cerises"],
    "plum": ["prunes"],
    "dates": ["dattes"],
...
"meat": {
    ...
    "processed_meat": [
        "saucisse", "saucisses", "boudins noirs"
    ],
    "ham": ["jambon"]
},
...
"dairy_eggs": {
    "milk": ["lait"],
    "cream": ["crème", "crème allégée", "crème coco", "crème pâtissière", "chantilly", "mascarpone"],
    "butter": ["beurre", "beurre bouillon"],
    "cheese": ["fromage", "fromage frais", "féta", "mozzarella", "fromage de fromage", "mascarpone"],
    "yogurt": ["yaourt"],
...
"grains_legumes": {
    "rice": ["riz"],
    "pasta": ["pâtes", "farfalle", "gnocchi", "gnocchis", "crozet", "pâtes à pâtes"],
    "bread": ["pain", "pains", "croûtons"],
    "flour": ["farine", "blé"],
    "quinoa": ["quinoa"],
    "lentils": ["lentilles"],
    "beans": ["haricot", "haricots", "haricots verts", "pois", "fèves"],
...
"spices": {
    "spices": ["ras el hanout", "garam masala", "tandoori",
